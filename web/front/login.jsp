...
<div class="soubg">
    <div class="sou">
        <span class="fr">
        	<span class="fl">你好，请<a href="../front/login.jsp">登录</a>&nbsp; <a href="../front/Regist.jsp" style="color:#ff4e00;">免费注册</a>&nbsp; </span>
        ...
        <div class="log_c">
            <form>
                <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="70">
                        <td>用户名</td>
                        <td><input type="text" value="" name="l_user" id="loginName" /></td>
                    </tr>
                    <tr height="70">
                        <td>密&nbsp; &nbsp; 码</td>
                        <td><input type="password" value="" name="l_pwd" id="loginPassword" /></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
